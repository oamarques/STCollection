SUBROUTINE SSTEDEFVALS( ECOND, EDIST, ESIGN, ETYPE, ISEED, N, W )
!
USE SSTEDEFINITIONS
!
!.. Scalar Arguments ..
...
!  =======                                                                     !
!                                                                              !
!  SSTEDEFVALS defines eigenvalue distributions to be used in the generation   !
!  of test matrices. See also subroutine SLATMS in LAPACK/TESTING/MATGEN.      !
!                                                                              !
!  Arguments:                                                                  !
!  =========                                                                   !
!                                                                              !
...
!
!.. External Functions ..
REAL( KIND=PREC ), EXTERNAL :: SLAMCH, SLARAN
!
!.. External Subroutine ..
EXTERNAL SLARNV
!
