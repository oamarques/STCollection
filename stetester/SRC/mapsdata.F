...
MODULE MAPSDATA
    CONTAINS
!-------------------------------------------------------------------------------
    SUBROUTINE SB_TO_ST( N, A, B, ALPHA, BETA )
!
...
!
    ...
    END DO
    BETA( N ) = ZERO
    END SUBROUTINE SB_TO_ST
!-------------------------------------------------------------------------------
    SUBROUTINE SB_TO_SZ( N, A, B, Q, E )
!
...
!
    ...
    Q( N ) = A( N )**2
    E( N ) = ZERO
    END SUBROUTINE SB_TO_SZ
!-------------------------------------------------------------------------------
    SUBROUTINE ST_TO_SZ( N, ALPHA, BETA, Q, E )
!
...
!
    ...
    END DO
    E( N ) = ZERO
    END SUBROUTINE ST_TO_SZ
!-------------------------------------------------------------------------------
    SUBROUTINE SZ_TO_SB( N, A, B, Q, E )
!
...
!
    ...
    END DO
    B( N ) = ZERO
    END SUBROUTINE SZ_TO_SB
!-------------------------------------------------------------------------------
    SUBROUTINE SSQTSHIFT( N, ALPHA, BETA )
!
