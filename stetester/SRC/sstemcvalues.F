...
!  =======                                                                     !
!                                                                              !
!  SSTEMCVALUES deals with the macro that sets eigenvalue distributions.       !
!                                                                              !
!  Arguments:                                                                  !
!  =========                                                                   !
!                                                                              !
...
IF ( IERR /= 0 ) CALL HANDLER( 2, 'ETYPE (subroutine SSTEMCVALUES)' ) 
...
IF ( IERR /= 0 ) CALL HANDLER( 2, 'ESIZE (subroutine SSTEMCVALUES)' ) 
