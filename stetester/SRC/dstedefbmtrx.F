SUBROUTINE DSTEDEFBMTRX( MTYPE, N, D, E, ISEED, WORK )
!
USE DSTEDEFINITIONS
!
!.. Scalar Arguments ..
...
!  =======                                                                     !
!                                                                              !
!  DSTEDEFBMTRX generates a bidiagonal matrix as indicated by MTYPE.           !
!                                                                              !
!  Arguments:                                                                  !
!  =========                                                                   !
!                                                                              !
...
!
!.. External Functions ..
REAL( KIND=PREC ), EXTERNAL :: DLAMCH, DLARND, DNRM2
!
...
!
     DO I = 1, N
        ...
        JSEED( 3 ) = ISEED( 3 ) ! I + 2
        JSEED( 4 ) = 2*I + 3
        CALL DLARNV( 3, JSEED, N+1-I, WORK )
        D( I ) = DNRM2( N+1-I, WORK, 1 )
        JSEED( 1 ) = ISEED( 1 ) ! I
        JSEED( 2 ) = ISEED( 2 ) ! I + 1
        JSEED( 3 ) = ISEED( 3 ) ! I + 2
        JSEED( 4 ) = 2*I + 11
        CALL DLARNV( 3, JSEED, N-I, WORK )
        E( I ) = DNRM2( N-I, WORK, 1 )
     END DO
     E( N ) = ZERO
!
CASE ( 3 )
...
!
     ...
     GAMMA = -TWO*LOG( ULP )
     DO I = 1, N
        D( I ) = EXP( GAMMA*DLARND( 2, ISEED ) )
        E( I ) = EXP( GAMMA*DLARND( 2, ISEED ) )
     END DO
     E( N ) = ZERO
!
END SELECT
! 
END SUBROUTINE DSTEDEFBMTRX
