SUBROUTINE SBDCHKRSLT( N, D, E, M, W, Z, LDZ, HBANDR, WORK, RESULT, INFO )
!
USE SSTEDEFINITIONS
! 
!.. Scalar Arguments ..
...
!  =======                                                                     !
!                                                                              !
!  SBDCHKRSLT checks the results of the LAPACK bidiagonal SVD. The             !
...
!
DO I = 0, MB-1
   CALL SCOPY( NB, Z( 1   , I+1 ), 1, WORK( IWRKU+NB*I ), 1 ) ! NB-by-MB (U)
   CALL SCOPY( NB, Z( 1+NB, I+1 ), 1, WORK( IWRKV+NB*I ), 1 ) ! NB-by-MB (V)
END DO
!
